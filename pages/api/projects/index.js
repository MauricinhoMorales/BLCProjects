...
export default authenticated(async function (req, res) {
  ...
  if (method === 'GET') {
    ...
    scopeValidationHandler(['read:projects'], req, res, async function (
      req,
      res
    ) {
      try {
    ...
    validationHandler(createProjectSchema, 'body', req, res, function (
      req,
      res
    ) {
      scopeValidationHandler(['create:projects'], req, res, async function (
        req,
        res
      ) {
