  ...
  switch (method) {
    case 'GET':
      validationHandler(taskIdSchema, 'query', req, res, function (req, res) {
        scopeValidationHandler(['read:tasks'], req, res, async function (
          req,
          res
        ) {
          const {
    ...
    case 'PUT':
      validationHandler(taskIdSchema, 'query', req, res, function (req, res) {
        validationHandler(updateTaskSchema, 'body', req, res, function (
          req,
          res
        ) {
          scopeValidationHandler(['update:tasks'], req, res, async function (
            req,
            res
          ) {
            const {
            ...
            const { body: task } = req;
            try {
              const updatedTaskId = await taskService.updateTask({ id, task });
    ...
    case 'DELETE':
      validationHandler(taskIdSchema, 'query', req, res, function (req, res) {
        scopeValidationHandler(['delete:tasks'], req, res, async function (
          req,
          res
        ) {
          const {
